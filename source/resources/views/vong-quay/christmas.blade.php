...
<head>
    ...
    <link href="{{ asset('css/christmas.css?v=1') }}<?php echo time(); ?>" rel="stylesheet">
</head>

<body>
    <div class="container-fluid hns-relative">
        <div class="row">
            <div
                class="col-xl-6 col-lg-5 col-md-12 col-sm-12 col-xs-12 col-12 justify-content-center hns-data-container hns-data-container-left">
                <div class="hns-logo">
                    <img class="hns-logo-img" src="{{ asset('img/christmas/title-main-min.png') }}" />
                </div>
                <div class="hns-title">
                    <img class="hns-title-img" src="{{ asset('img/christmas/title-min.png') }}" />
                </div>
            ...
            <div
                class="col-xl-6 col-lg-7 col-md-12 col-sm-12 col-xs-12 col-12 justify-content-center hns-data-container hns-data-container-right">
        ...
        <div class="hns-footer">
            <img class="hns-footer-img" src="{{ asset('img/christmas/bg-footer-min.png') }}" />
        </div>
    </div>
